Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/412a94f3f718551499162463cc11d798"
{
	Properties
	{
...
Decal0.m_DecalScale = float4(0.11,0.125,1,0);
Decal0.m_DecalSideOffset = float4(0,0,0,0);
Decal0.m_DecalPosition = float4(0.0965,0.5125,0,0);
